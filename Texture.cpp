...
bool LoadTGA(Texture * texture, char * filename)				// Load a TGA file
{
	...
	{
		std::cerr << "CTGA file be type 2 or type 10. Invalid image." << std::endl;
...
{																			// TGA Loading code nehe.gamedev.net)
	...
	{										
		std::cerr << "Could not read info header." << std::endl;
	...
	{
		std::cerr << "Invalid texture information" << std::endl;
...
{ 
	...
	do
	{
		...
		{
			std::cerr << "Could not read RLE header" << std::endl;
